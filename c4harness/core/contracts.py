...
class FailureCategory(str, Enum):
    """Stable categories for structured failure classification."""
...
@dataclass(slots=True)
class FailureRecord:
    """Serializable structured failure with stable category, code, and attribution.

    Designed for deterministic classification without brittle string parsing.
    Each record carries enough metadata for replanning, history attribution,
    and debugging.
    """
    ...
    blame: str = ""  # worker | missing_context | contract | policy_permission |
    # environment | integration_conflict | deterministic_rejection | semantic_inconclusive
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "phase_or_check": self.phase_or_check,
